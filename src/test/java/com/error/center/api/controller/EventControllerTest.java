...
public class EventControllerTest {
    ...
    public void testSaveInvalidLevel() throws Exception {
        mvc.perform(MockMvcRequestBuilders.post(URL_BASE)
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.error.fields[0].name").value("level"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.error.fields[0].message")
    ...
    public void testSearch() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get(URL_BASE)
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[0].level").value(LEVEL))
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[0].description").value(DESCRIPTION))
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[0].log").doesNotExist())
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[0].origin").value(ORIGIN))
        ;
    }
